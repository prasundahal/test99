...
@section('content')
    ...
    <div class="col-lg-9 col-md-3 ml-auto">
        ...
        <div class="sidebar-content p-4">
            <form action="{{ route('cashapp.update',$cashapp->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form">
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Title</label>
                        <input type="text" class="form-control" id="inputEmail4" value="{{ $cashapp->title }}" name="title" placeholder="Title">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Balance</label>
                        <input type="number" class="form-control" id="inputPassword4" value="{{ $cashapp->balance }}" name="balance" placeholder="Balance">
                    </div>
                </div>
