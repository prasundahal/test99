            ...
            <table class="w-100 table-striped">
                ...
                @foreach ($account as $accounts)
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="{{ route('restore.games',$accounts->id) }}" class="text-white">Restore</a> |
                            <a href="{{ route('fdel.games',$accounts->id) }}" onclick="return confirm('Are you sure?');" class="text-danger">Delete</a>
                        </td>
                    </tr>
                @endforeach
