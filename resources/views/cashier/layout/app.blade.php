...
<head>
    ...
    <!-- Custom Links Ends -->
    {{-- script --}}
    <script src="{{ asset('admin/assets/jquery-3.5.1/jquery-3.5.1.js ') }}"></script>
    <!-- Jquery Link Ends-->
    ...
    <script src="{{ asset('public/admin/assets/bootstrap-4.3.1/js/bootstrap.min.js') }} "></script>
    <script src="{{ asset('public/admin/assets/bootstrap-4.3.1/js/bootstrap.min.js') }}.map "></script>
...
{{-- <div class="overlay2 position-absolute">
    <img src="{{ asset('public/admin/assets/images/bg1.jpg') }}" class="img-fluid">
</div> --}}
<!-- Whole Body Wrapper Starts -->
@include('cashier.inc.cashier-nav')
