            ...
            <table class="table datatable">
               <thead>
                  <tr>
                     ...
                     <th scope="col" style="color: white">Note</th>
                     <th scope="col" style="color: white">CashApp Limit</th>
                     <th scope="col" style="color: white">Driving License</th>
                     <th scope="col" style="color: white">State</th>
                     <th scope="col" style="color: white">Crime</th>
